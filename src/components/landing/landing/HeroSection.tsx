              ...
              >
                ...
                <div className="bg-white px-4 py-2 border-b border-gray-100 overflow-x-auto shrink-0">
                   <div className="flex gap-2">
                      <button className="bg-blue-600 text-white text-xs px-3 py-1 rounded-full whitespace-nowrap">Alle</button>
                      <button className="bg-gray-100 text-gray-600 text-xs px-3 py-1 rounded-full whitespace-nowrap">Natur</button>
                      <button className="bg-gray-100 text-gray-600 text-xs px-3 py-1 rounded-full whitespace-nowrap">Architektur</button>
                      {currentConfig.type !== 'mobile' && (
                        <>
                          <button className="bg-gray-100 text-gray-600 text-xs px-3 py-1 rounded-full whitespace-nowrap">Reisen</button>
                          <button className="bg-gray-100 text-gray-600 text-xs px-3 py-1 rounded-full whitespace-nowrap">Essen</button>
                        </>
                      )}
                   </div>
                </div>
                ...
                <div className="flex-1 overflow-hidden flex items-center justify-center p-4">
                   <div className="text-center">
                      ...
                      <p className="text-blue-600 text-sm font-medium">Keine Fotos gefunden</p>
                      <p className="text-gray-500 text-xs mt-1">Versuche es mit einem anderen Suchbegriff oder Filter</p>
                   </div>
                </div>
