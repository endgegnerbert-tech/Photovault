...
"[project]/src/lib/storage/native-keychain.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function isTauri() {
    ...
    return ("TURBOPACK compile-time value", "undefined") !== 'undefined' && window.__TAURI__ !== undefined;
}
async function storeKeyNative(key) {
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tauri$2d$apps$2f$api$2f$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["invoke"])('store_secret_key', {
            key: encoded
        });
    } catch (error) {
...
async function getDeviceIdNative() {
    ...
    try {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tauri$2d$apps$2f$api$2f$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["invoke"])('get_device_id');
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__178e2dc1._.js.map